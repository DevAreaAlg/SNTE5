<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterMascore.master" CodeBehind="MEM_UPD_DATOS_TRABAJADOR.aspx.vb" Inherits="SNTE5.MEM_UPD_DATOS_TRABAJADOR" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
               ...
               <div class="module_subsec" style="justify-content: space-between; flex-direction: row-reverse;">
                    <div style="display: flex; align-items: center;">
                        <asp:LinkButton runat="server" ValidationGroup="generar_reporte_param" Style="font-size: 18px;" ID="lnk_vermanual" Enabled="false">
                            Manual Usuario<i class="fa fa-download" aria-hidden="true" style="font-size:20px; margin-left:5px;" ></i>
                        </asp:LinkButton>
                    </div>
                </div> 
                <div class="module_subsec columned low_m three_columns">
                    ...
                    <div class="flex_1 module_subsec module_subsec_elements no_m no_column" style="margin-bottom: 10px;">
                        ...
                        <asp:Button ID="btn_reporte" CssClass="btn btn-primary module_subsec_elements no_tbm" runat="server" Text="Reporte Delegación" />
    ...
    <section class="panel" runat="server" visible="false" id="pnl_expedientes">
                    ...
                    <div class="module_subsec_elements">
                        <div class="text_input_nice_div module_subsec_elements_content">
                            ...
                            <div class="text_input_nice_labels">
                                ...
                                <asp:RequiredFieldValidator runat="server" CssClass="alertaValidator bold"
                                    ControlToValidate="txt_correo" Display="Dynamic" ErrorMessage=" Falta Dato!"
                                    ValidationGroup="val_Persona" />
                            </div>
                        </div>
            ...
            <div class="module_subsec columned low_m three_columns">
                <div class="module_subsec_elements">
                    <div class="text_input_nice_div module_subsec_elements_content">
                        <asp:DropDownList runat="server" ID="cmb_banco" CssClass="btn btn-primary2 dropdown_label"
                            AutoPostBack="true" />
                        <div class="text_input_nice_labels">
                            <asp:Label runat="server" ID="text_cmb_banco" CssClass="text_input_nice_label" Text="*Banco:" />
                ...
                <div class="module_subsec_elements">
                    <div class="text_input_nice_div module_subsec_elements_content">
                        ...
                        <div class="text_input_nice_labels">
                            <asp:Label runat="server" ID="text_clabe_verifi" Text="*CLABE:" />
                            <asp:RequiredFieldValidator ID="rfv_txt_clabe" runat="server" ControlToValidate="txt_clabe"
                                CssClass="alertaValidator bold" Display="Dynamic" ErrorMessage=" Falta Dato!" Enabled="false"
                                ValidationGroup="val_Persona" />
                            <ajaxToolkit:FilteredTextBoxExtender runat="server" Enabled="True" FilterType="Numbers"
                ...
                <div class="module_subsec_elements">
                    <div class="text_input_nice_div module_subsec_elements_content">
                        ...
                        <div class="text_input_nice_labels">
                            <asp:Label runat="server" ID="text_clabe_conf_verifi" Text="*Confirmar CLABE:" />
        ...
        <asp:Panel ID="pnl_modal_confirmar" runat="server" Style="display: none;" Align="Center">
            <div style="position: fixed; top: 0; left: 0; display: flex; width: 100%; height: 100%; background-color: rgba(0,0,0,.6); justify-content: center; align-items: center;">
                <section class="panel no_bm " style="display: inline-block">
                    ...
                    <div class="panel-body align_items_flex_center" style="width:600px; height:600px;">
                        <div class="panel-body align_items_flex_center">
                        <asp:Imagebutton runat="server" ImageUrl="~/img/aviso.png" style="width:516px; height:500px;" 
                             /> 
                        
                        <asp:Button ID="btn_confirmar" runat="server" CssClass="btn btn-primary" Text="Acepto" TabIndex="1" /> 
                        &nbsp;&nbsp;
                        <asp:Button ID="btn_cancelar" runat="server" CssClass="btn btn-primary" Text="No acepto" />
                         </div>       
                    </div>
                </section>
            </div>
     ...
     <section class="panel" runat="server" visible="false" id="Estatus_panel">
        <header runat="server" id="Header1" class="panel-heading panel_header_folder">
            <span class="panel_folder_toogle_header">Estatus Trabajador</span>
            <span class="panel_folder_toogle down" runat="server" id="Span1">&rsaquo;</span>
        </header>
        <div class="panel-body">
            <div class="panel-body_content init_show" runat="server" id="Div1">
                <div class="module_subsec columned low_m two_columns">
                    ...
                    <div class="flex_1 module_subsec module_subsec_elements no_m no_column" style="margin-bottom: 10px;">
                        <asp:Button ID="Btn_Guardar_Estatus" CssClass="btn btn-primary module_subsec_elements no_tbm " runat="server" Text="Guardar" ValidationGroup="val_Depe_NumCtrl" />
                    </div>
                </div>

             <asp:Label ID="Alerta_estatus" runat="server" CssClass="module_subsec flex_center alerta"></asp:Label>
