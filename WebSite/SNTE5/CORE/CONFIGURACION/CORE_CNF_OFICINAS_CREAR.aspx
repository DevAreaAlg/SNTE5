<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterMascore.master" CodeBehind="CORE_CNF_OFICINAS_CREAR.aspx.vb" Inherits="SNTE5.CORE_CNF_OFICINAS_CREAR" MaintainScrollPositionOnPostback ="true" %>
        ...
        <div class="panel-body">
            <div class="panel-body_content init_show">
                ...
                <div class="module_subsec low_m columned three_columns">
                    ...
                    <div class="module_subsec_elements">
                        <div class="text_input_nice_div module_subsec_elements_content">
                            <asp:DropDownList ID="ddl_jefe" CssClass="btn btn-primary2 dropdown_label" runat="server"
                                AutoPostBack="False">
                            </asp:DropDownList>
                            <div class="text_input_nice_labels">
                                <span class="text_input_nice_label">*Jefe de oficina:</span>
                                <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator_jefe" CssClass="alertaValidator"
                                    ControlToValidate="ddl_jefe" Display="Dynamic" ErrorMessage=" Falta Dato!"
                        ...
                        <div class="text_input_nice_div module_subsec_elements_content">
                            ...
                            <div class="text_input_nice_labels">
                                ...
                                <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender_callenum" runat="server" Enabled="True"
                                    FilterType="Custom, Numbers,UppercaseLetters,LowercaseLetters" ValidChars=" ,Á,É,Í,Ó,Ú,Ñ,á,é,í,ó,ú,ñ,#,-,_/Üü" TargetControlID="txt_calle_num">
                                </ajaxToolkit:FilteredTextBoxExtender>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="text_input_nice_div module_subsec_elements_content">
                            ...
                            <div class="text_input_nice_labels">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator_estado" runat="server" ControlToValidate="ddl_Estado"
                                 CssClass="textogris" Display="Dynamic" ErrorMessage=" Falta Dato!" ValidationGroup="val_Oficina"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                    </div>
