<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterMascore.master" CodeBehind="CORE_CNF_OFICINAS.aspx.vb" Inherits="SNTE5.CORE_CNF_OFICINAS" MaintainScrollPositionOnPostback ="true" %>
                ...
                <div class="module_subsec columned low_m no_rm five_columns" style="flex: 1;">
                    ...
                    <div class=" module_subsec_elements no_m">
                        <div class="module_subsec_elements_content vertical">
                            ...
                            <asp:DropDownList ID="ddl_estado" runat="server" class="btn btn-primary2 dropdown_label" AutoPostBack="False">
                            </asp:DropDownList>
                        </div>
                    </div>
                    <div class=" module_subsec_elements no_m">
