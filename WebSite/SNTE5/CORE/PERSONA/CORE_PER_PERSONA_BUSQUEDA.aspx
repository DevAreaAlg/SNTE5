<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterMascore.master" CodeBehind="CORE_PER_PERSONA_BUSQUEDA.aspx.vb" Inherits="SNTE5.CORE_PER_PERSONA_BUSQUEDA" MaintainScrollPositionOnPostback ="true" %>
    ...
    <section class="panel">
        <div class="overflow_x shadow">
            ...
            <asp:DataGrid ID="dag_persona" runat="server" AutoGenerateColumns="False" CssClass="table table-striped"
                ...
                <Columns>
                    <asp:BoundColumn ItemStyle-Width="15%" DataField="ID" HeaderText="Núm. cliente"></asp:BoundColumn>

                    <asp:BoundColumn ItemStyle-Width="30%" DataField="NOMBRE" HeaderText="Nombre"></asp:BoundColumn>

                    <asp:BoundColumn ItemStyle-Width="20%" DataField="ESTATUS" HeaderText="Estatus Afiliado"></asp:BoundColumn>
