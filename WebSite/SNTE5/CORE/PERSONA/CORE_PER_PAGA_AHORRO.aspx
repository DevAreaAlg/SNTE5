<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterMascore.master" CodeBehind="CORE_PER_PAGA_AHORRO.aspx.vb" Inherits="SNTE5.CORE_PER_PAGA_AHORRO" MaintainScrollPositionOnPostback="true" %>
    ...
    <div id="dvMain" runat="server">
        <section class="panel">
            <header class="panel-heading">
                <span>Agremiados en espera de pago ahorro</span>
            </header>
            <div class="panel-body">

                <div align="left">
                    <asp:Label runat="server" CssClass="text_input_nice_label" Text="Ciclo:" />
                    <asp:DropDownList ID="cmb_ciclo" runat="server" class="btn btn-primary2 dropdown_label" >
                    </asp:DropDownList>
                    <asp:Label runat="server" CssClass="module_subsec_elements module_subsec_medium-elements" Text="Tipo Trabajador" />
                    <asp:DropDownList ID="tipo_trab" runat="server" class="btn btn-primary2 dropdown_label" Style="text-align: center" Enabled="TRUE">
                    </asp:DropDownList>
                    <asp:Label runat="server" CssClass="module_subsec_elements module_subsec_medium-elements" Text="Estatus Ahorro:" />
                    <asp:DropDownList ID="ahorro" runat="server" class="btn btn-primary2 dropdown_label" Style="text-align: center" Enabled="TRUE">
                    </asp:DropDownList>
                    <asp:Button runat="server" ID="Filtro" CssClass="btn btn-primary"
                        Text="Filtrar" />
                </div>
                <asp:UpdatePanel runat="server">
                    <ContentTemplate>
                        ...
                        <div align="right">
                            ...
                            <asp:Label runat="server" CssClass="module_subsec_elements module_subsec_medium-elements" Text="Total:" />
                            <asp:TextBox runat="server" ID="lbl_acumulado" CssClass="text_input_nice_input module_subsec_elements module_subsec_bigger-elements" Enabled="false" />
                        </div>
                        ...
                        <div class="overflow_x shadow ">
                            <asp:GridView ID="DAG_Analisis" runat="server" AutoGenerateColumns="False" CssClass="table table-striped"
                                GridLines="None" Width="100%" AutoPostBack="true" AllowPaging="true" HeaderStyle-HorizontalAlign="Center" PageSize="1000">
                                <HeaderStyle CssClass="table_header" />
                                <PagerSettings Mode="Numeric" Position="Bottom" PageButtonCount="25" />
                                <PagerStyle HorizontalAlign="Center" Width="300" />
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="DELE" HeaderText="Delegacion">
                                        <ItemStyle Width="5%"></ItemStyle>
                                    </asp:BoundField>
                                    <asp:BoundField DataField="AHORRO" HeaderText="Saldo Ahorro">
                                        <ItemStyle Width="10%"></ItemStyle>
                                    </asp:BoundField>
                    ...
                    <Triggers>
                        ...
                        <asp:AsyncPostBackTrigger ControlID="Filtro" />
                    </Triggers>
                </asp:UpdatePanel>
                <div class="module_subsec low_m columned four columns top_m flex_end">
                    <asp:Button runat="server" ID="btn_layout_bancos" CssClass="btn btn-primary"
                        Text="Layout para Banco" ValidationGroup="val_laybancos" />
                </div>
                <div align="center">
                    ...
                    <div class="module_subsec_elements">
                        <div class="text_input_nice_div module_subsec_elements_content">
                            <asp:Button runat="server" ID="btn_pagar" CssClass="btn btn-primary module_subsec_elements no_tbm"
                                Text="Pagar" OnClientClick="BtnClick()" />
                        </div>
                    </div>
                </div>
            </div>
