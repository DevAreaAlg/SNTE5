Public Class CORE_PER_PERSONA_BUSQUEDA
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
            ...
            llena_personas()
        End If
        TryCast(Me.Master, MasterMascore).CargaASPX("Búsqueda de Personas", "Personas Afiliadas")
    End Sub
    ...
    Private Sub llena_personas()
        ...
        Session("cmd").ActiveConnection = Session("Con")
        Session("cmd").CommandType = System.Data.CommandType.StoredProcedure
        Session("cmd").CommandText = "SEL_PERSONAS"
        Session("rs") = Session("cmd").Execute()
    ...
    Protected Sub btn_busca_persona_Click(sender As Object, e As EventArgs) Handles btn_busca_persona.Click
        ...
        Else
            ...
            Session("cmd").Parameters.Append(Session("parm"))
            Session("cmd").CommandText = "SEL_FILTRO_PERSONA"
            Session("rs") = Session("cmd").Execute()
            custDA.Fill(dtper, Session("rs"))
            Session("Con").Close()
            If dtper.Rows.Count > 0 Then
    ...
    Protected Sub btn_nuevo_Click(sender As Object, e As EventArgs) Handles btn_nuevo.Click
        Session("PERSONAID") = "-1"
        Response.Redirect("CORE_PER_PERSONA.aspx")
    End Sub
