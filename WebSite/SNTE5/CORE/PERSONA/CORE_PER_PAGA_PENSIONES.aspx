<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterMascore.master" CodeBehind="CORE_PER_PAGA_PENSIONES.aspx.vb" Inherits="SNTE5.CORE_PER_PAGA_PENSIONES" MaintainScrollPositionOnPostback="true" %>
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                ...
                <div align="left">
                    ...
                    <asp:Label runat="server" CssClass="module_subsec_elements module_subsec_medium-elements" Text="Estatus Pensión:" />
                        ...
                        <div class="overflow_x shadow ">
                            <asp:GridView ID="DAG_Analisis" runat="server" AutoGenerateColumns="False" CssClass="table table-striped"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="CLIENTE" HeaderText="Beneficiario">
                                        <ItemStyle Width="25%"></ItemStyle>
                                    </asp:BoundField>
                                    <asp:BoundField DataField="NUMCTRL" HeaderText="RFC Demandado">
                                        <ItemStyle Width="20%"></ItemStyle>
                                    </asp:BoundField>
                                    <asp:BoundField DataField="MONTO" HeaderText="Monto Pension">
                                        <ItemStyle Width="20%"></ItemStyle>
                                    </asp:BoundField>
