<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterMascore.master" CodeBehind="CORE_PER_PAGA_RETRO_CHEQUE.aspx.vb" Inherits="SNTE5.CORE_PER_PAGA_RETRO_CHEQUE" MaintainScrollPositionOnPostback="true" %>
                    ...
                    <ContentTemplate>
                            ...
                            <div class="module_subsec columned low_m three_columns">
                                ...
                                <div class="module_subsec_elements text_input_nice_div">
                                    ...
                                    <div class="text_input_nice_labels">
                                        ...
                                        TargetControlID="txt_idCliente1" FilterType="Numbers" Enabled="True" /--%>
                                    </div>
                                </div>
                        ...
                        <div>
                            ...
                            <div class="module_subsec low_m columned four columns top_m flex_end">
                                ...
                                &nbsp; &nbsp; &nbsp;
                                <asp:Button ID="btnPoliza" runat="server" class="btn btn-primary" Text="Imprimir Póliza" Visible="false"  />
                                &nbsp; &nbsp; &nbsp;
                                <%-- Deshacer --%>
