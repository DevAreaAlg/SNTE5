<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterMascore.master" CodeBehind="CRED_EXP_PAGACREDPER.aspx.vb" Inherits="SNTE5.CRED_EXP_PAGACREDPER" MaintainScrollPositionOnPostback="true" %>
            ...
            <div class="panel-body">
                <asp:UpdatePanel runat="server">
                    <ContentTemplate>
                        ...
                        <div align="right">
                            <asp:Label runat="server" CssClass="module_subsec_elements module_subsec_medium-elements" Text="Presupuesto actual:" />
                            <asp:TextBox runat="server" ID="lbl_presactual" CssClass="text_input_nice_input module_subsec_elements module_subsec_bigger-elements" Enabled="false" />
                        </div>
                        <div align="right">
                        ...
                        <div align="right">
                            <asp:Label runat="server" CssClass="module_subsec_elements module_subsec_medium-elements" Text="Presupuesto final:" />
                            <asp:TextBox runat="server" ID="lbl_presfinal" CssClass="text_input_nice_input module_subsec_elements module_subsec_bigger-elements" Enabled="false" />
                        </div>
                        <div align="right">
                ...
                <div class="module_subsec low_m columned four columns top_m flex_end">
                    ...
                    &nbsp; &nbsp; &nbsp;
                <asp:Button runat="server" ID="btn_pagar_pds" CssClass="btn btn-primary"
                    Text="Pagar PDs" Visible="False" />
                </div>
                <div align="center">
