...
#Region "Procesa Layout Bancos"
    ...
    Private Sub PagaCreditos()
        ...
        NombreArchivo = FechaSistema.Year.ToString + FechaSistema.Month.ToString + FechaSistema.Day.ToString + "_" + NoRandom.Next().ToString + "_PC_" + NombreArchivo.Replace(".TXT", "_PROCESADO.txt").ToString
        ...
        Try
            ...
            Session("cmd").Parameters.Append(Session("parm"))
            Session("parm") = Session("cmd").CreateParameter("FILENAME", Session("adVarChar"), Session("adParamInput"), 200, NombreArchivo)
            Session("cmd").Parameters.Append(Session("parm"))
