<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterMascore.Master" CodeBehind="CRED_EXP_ESTADO_CUENTA.aspx.vb" Inherits="SNTE5.CRED_EXP_ESTADO_CUENTA" MaintainScrollPositionOnPostback="true" %>
        ...
        <div class="panel-body">
            ...
            <div class="module_subsec columned low_m three_columns">
                ...
                <div class="module_subsec_elements text_input_nice_div">
                    ...
                    <div class="text_input_nice_labels">
                        <asp:Label ID="lbl_ciclo" runat="server" CssClass="text_input_nice_label" Text="*Ciclo:"></asp:Label>
