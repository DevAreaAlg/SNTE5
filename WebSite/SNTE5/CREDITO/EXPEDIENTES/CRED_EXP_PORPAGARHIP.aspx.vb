...
Public Class CRED_EXP_PORPAGARHIP
    Inherits System.Web.UI.Page

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        TryCast(Me.Master, MasterMascore).CargaASPX("Préstamos complementarios pendientes de aprobación", "Préstamos complementarios pendientes de aprobación")
        ...
        For Each row As GridViewRow In DAG_Analisis.Rows
            If row.RowType = DataControlRowType.DataRow Then
                ...
                If chkRow.Checked Then
                    registros += 1
                    monto += (CDec(row.Cells(8).Text))
                    data = monto.ToString("C")
                    presuFin -= (CDec(row.Cells(8).Text))
