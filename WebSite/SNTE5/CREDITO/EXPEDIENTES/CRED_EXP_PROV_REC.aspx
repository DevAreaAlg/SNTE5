<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterMascore.master" CodeBehind="CRED_EXP_PROV_REC.aspx.vb" Inherits="SNTE5.CRED_EXP_PROV_REC" MaintainScrollPositionOnPostback ="true" %>
                        ...
                        <div class="module_subsec_elements">
                            <div class="text_input_nice_div module_subsec_elements_content">
                                ...
                                <div class="text_input_nice_labels">
                                    <asp:Label ID="lbl_numaval" runat="server" CssClass="text_input_nice_label" Text="*Id de la persona:"></asp:Label>
