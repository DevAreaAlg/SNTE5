...
Public Class CRED_EXP_PAGACREDPER
    Inherits Page
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load

        TryCast(Master, MasterMascore).CargaASPX("Préstamos de ahorro por pagar", "Préstamos de ahorro por pagar")
...
#Region "Pagar PDs"
    ...
    Protected Sub btn_pagar_pds_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btn_pagar_pds.Click
