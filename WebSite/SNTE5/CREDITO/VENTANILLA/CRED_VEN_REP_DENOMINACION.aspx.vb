Public Class CRED_VEN_REP_DENOMINACION
    ...
    Private Sub LlenaReporteCorteInicial(ByVal idcaja As Integer, ByVal seriefolio As String)
        ...
        With document
            .AddAuthor("Desarrollo - _______________")
            .AddCreationDate()
            .AddCreator("__________________ - Corte Inicial")
    ...
    Private Sub LlenaReporteTransEfec(ByVal idcaja As Integer, ByVal seriefolio As String)
        ...
        Dim Reader As iTextSharp.text.pdf.PdfReader = Nothing
        Reader = New iTextSharp.text.pdf.PdfReader(Session("APPATH").ToString + "\DocPlantillas\TrasnsEfectivo.pdf")
