...
Public Class CAP_PROD_APARTADO4
    Inherits System.Web.UI.Page
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        TryCast(Me.Master, MasterMascore).CargaASPX("Asignación del Producto a Oficinas", "ASIGNACIÓN DEL PRODUCTO A OFICINAS ")
        'LLENO LOS COMBOS
    ...
    Protected Sub llena_sursales()
        ...
        If dtSucursalesAsignados.Rows.Count > 0 Then
            dag_suc_prod_cap.Visible = True
            dag_suc_prod_cap.DataSource = dtSucursalesAsignados
            dag_suc_prod_cap.DataBind()
        Else
            dag_suc_prod_cap.Visible = False
        End If
    End Sub
    ...
    Protected Sub btn_guardar_r_Click(sender As Object, e As EventArgs)
        ...
        For i As Integer = 0 To dag_suc_prod_cap.Rows.Count() - 1
            dtSucursales.Rows.Add(CInt(dag_suc_prod_cap.Rows(i).Cells(0).Text), dag_suc_prod_cap.Rows(i).Cells(1).Text, Convert.ToInt32(DirectCast(dag_suc_prod_cap.Rows(i).FindControl("chk_asignado"), CheckBox).Checked))
        Next
