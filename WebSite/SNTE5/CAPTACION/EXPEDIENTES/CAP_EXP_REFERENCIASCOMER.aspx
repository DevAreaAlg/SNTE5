<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterMascore.master" CodeBehind="CAP_EXP_REFERENCIASCOMER.aspx.vb" Inherits="SNTE5.CAP_EXP_REFERENCIASCOMER" MaintainScrollPositionOnPostback ="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <asp:UpdatePanel ID="upd_referencia" UpdateMode="Conditional" runat="server">
                    <ContentTemplate>
                        ...
                        <div class="module_subsec low_m columned three_columns">
                            ...
                            <div class="module_subsec_elements">
                                <div class="text_input_nice_div module_subsec_elements_content">
                                    ...
                                    <div class="text_input_nice_labels">
                                        <asp:Label ID="lbl_nocta_efe" runat="server" CssClass="text_input_nice_label" Text="*Número de cuenta:"></asp:Label>
                                ...
                                <div class="text_input_nice_div module_subsec_elements_content">
                                    ...
                                    <div class="text_input_nice_labels">
                                        ...
                                        <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" runat="server"
                                            Enabled="True" FilterType="Numbers" TargetControlID="txt_telefono">
                                        </ajaxToolkit:FilteredTextBoxExtender>
                        ...
                        <div class="module_subsec flex_end">
                            <asp:Button ID="btn_guarda_AcEfectivo" runat="server" class="btn btn-primary" Text="Guardar" ValidationGroup="val_RefCom" />
                        </div>
                ...
                <asp:UpdatePanel ID="upd_prov" UpdateMode="Conditional" runat="server">
                    <ContentTemplate>
                        ...
                        <div class="module_subsec low_m columned three_columns">
                            <div class="module_subsec_elements">
                                <div class="text_input_nice_div module_subsec_elements_content">
                                    <asp:TextBox ID="txt_institucion_Prov" runat="server" class="text_input_nice_input" MaxLength="100"></asp:TextBox>
                                    <div class="text_input_nice_labels">
                            ...
                            <div class="module_subsec_elements">
                                <div class="text_input_nice_div module_subsec_elements_content">
                                    <asp:TextBox ID="txt_NomEjec_Prov" runat="server" class="text_input_nice_input" MaxLength="100"></asp:TextBox>
                                    <div class="text_input_nice_labels">
                                ...
                                <div class="text_input_nice_div module_subsec_elements_content">
                                    ...
                                    <div class="text_input_nice_labels">
                                        ...
                                        <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender7" runat="server" Enabled="True"
                                            FilterType="Numbers" TargetControlID="txt_saldo_efe_Prov">
                                        </ajaxToolkit:FilteredTextBoxExtender>
                        ...
                        <div class="module_subsec flex_end">
                            <asp:Button ID="btn_guarda_CXPnoDOC" runat="server" class="btn btn-primary" Text="Guardar" ValidationGroup="val_prov" />
                        </div>
    ...
    <section class="panel" id="panel_clientes">
        <header class="panel_header_folder panel-heading">
            <span>Principales afiliados</span>
            <span class=" panel_folder_toogle up" href="#">&rsaquo;</span>
        </header>
                ...
                <asp:UpdatePanel ID="upd_clientes" UpdateMode="Conditional" runat="server">
                    <ContentTemplate>
                        ...
                        <div class="module_subsec low_m columned three_columns">
                            <div class="module_subsec_elements">
                                <div class="text_input_nice_div module_subsec_elements_content">
                                    <asp:TextBox ID="txt_institucion_Cte" runat="server" class="text_input_nice_input" MaxLength="100"></asp:TextBox>
                                    <div class="text_input_nice_labels">
                                        <asp:Label ID="lbl_institucion_Cte" runat="server" CssClass="text_input_nice_label" Text="*Nombre del afiliado:"></asp:Label>
                                ...
                                <div class="text_input_nice_div module_subsec_elements_content">
                                    ...
                                    <div class="text_input_nice_labels">
                                        ...
                                        <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender8" runat="server"
                                            Enabled="True" FilterType="Numbers" TargetControlID="txt_nocta_Cte">
                                        </ajaxToolkit:FilteredTextBoxExtender>
                            ...
                            <div class="module_subsec_elements">
                                <div class="text_input_nice_div module_subsec_elements_content">
                                    <asp:TextBox ID="txt_NomEjec_Cte" runat="server" class="text_input_nice_input" MaxLength="100"></asp:TextBox>
                                    <div class="text_input_nice_labels">
                                ...
                                <div class="text_input_nice_div module_subsec_elements_content">
                                    ...
                                    <div class="text_input_nice_labels">
                                        ...
                                        <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender10" runat="server"
                                            Enabled="True" FilterType="Numbers" TargetControlID="txt_telefono_Cte">
                                        </ajaxToolkit:FilteredTextBoxExtender>
                                ...
                                <div class="text_input_nice_div module_subsec_elements_content">
                                    ...
                                    <div class="text_input_nice_labels">
                                        ...
                                        <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender11" runat="server" Enabled="True"
                                            FilterType="Numbers" TargetControlID="txt_saldo_efe_Cte">
                                        </ajaxToolkit:FilteredTextBoxExtender>
                        ...
                        <div class="module_subsec flex_end">
                            <asp:Button ID="btn_guardabienmu" runat="server" class="btn btn-primary" Text="Guardar" ValidationGroup="val_cte" />
                        </div>
