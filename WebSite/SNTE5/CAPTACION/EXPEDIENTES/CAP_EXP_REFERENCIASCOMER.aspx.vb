Public Class CAP_EXP_REFERENCIASCOMER
...
#Region "Referencias Comerciales"
    ...
    Protected Sub Guarda_RefBancarias()
        ...
        Session("cmd").Parameters.Append(Session("parm"))
        Session("parm") = Session("cmd").CreateParameter("SALDO", Session("adVarChar"), Session("adParamInput"), 19, txt_saldo_efe.Text)
        Session("cmd").Parameters.Append(Session("parm"))
    ...
    Protected Sub Guarda_Proveedores()
        ...
        Session("cmd").Parameters.Append(Session("parm"))
        Session("parm") = Session("cmd").CreateParameter("LIMITECRED", Session("adVarChar"), Session("adParamInput"), 18, CDec(txt_nocta_Prov.Text))
        Session("cmd").Parameters.Append(Session("parm"))
        ...
        Session("cmd").Parameters.Append(Session("parm"))
        Session("parm") = Session("cmd").CreateParameter("SALDO", Session("adVarChar"), Session("adParamInput"), 19, CDec(txt_saldo_efe_Prov.Text))
        Session("cmd").Parameters.Append(Session("parm"))
        Session("parm") = Session("cmd").CreateParameter("IDUSER", Session("adVarChar"), Session("adParamInput"), 10, Session("USERID").ToString)
        Session("cmd").Parameters.Append(Session("parm"))
        Session("parm") = Session("cmd").CreateParameter("IDSESION", Session("adVarChar"), Session("adParamInput"), 15, Session("Sesion").ToString)
    ...
    Protected Sub Guarda_Clientes()
        ...
        Session("cmd").Parameters.Append(Session("parm"))
        Session("parm") = Session("cmd").CreateParameter("NOMCONTACTO", Session("adVarChar"), Session("adParamInput"), 200, txt_NomEjec_Cte.Text)
        Session("cmd").Parameters.Append(Session("parm"))
