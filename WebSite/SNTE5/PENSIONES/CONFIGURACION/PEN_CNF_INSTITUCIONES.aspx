<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterMascore.master" CodeBehind="PEN_CNF_INSTITUCIONES.aspx.vb" Inherits="SNTE5.PEN_CNF_INSTITUCIONES" MaintainScrollPositionOnPostback ="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="panel-body">
            <div class="module_subsec no_m">
                ...
                <div class="module_subsec low_m  no_lm" style="margin-bottom: 10px;">
                    <asp:Button ID="btn_busca_institucion" CssClass="btn btn-primary" OnClick="btn_busca_institucion_Click" runat="server" Text="Buscar" />
                </div>
            </div>
    ...
    <div class="panel" style="background-color: transparent; box-shadow: none;">
        <div class="flex_end">
            <asp:Button ID="btn_Agregar_Institucion" runat="server" class="btn btn-primary" Text="Nueva Institución" />
        </div>
    </div>
    ...
    <section class="panel">
        <div class="overflow_x shadow">
            ...
            <asp:DataGrid ID="dag_instituciones" runat="server" AutoGenerateColumns="False" class="table table-striped"
                GridLines="None">
                <Columns>
