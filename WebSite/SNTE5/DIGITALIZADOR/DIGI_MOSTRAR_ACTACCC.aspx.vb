Public Class DIGI_MOSTRAR_ACTACCC
    ...
    Private Sub VerDocumentoDigitalizado()
        ...
        Dim sqlCmdObj As New System.Data.SqlClient.SqlCommand("SEL_MOSTRAR_IMAGEN_ACTA_CCC_PLD", sqlConnection)
        sqlCmdObj.CommandType = System.Data.CommandType.StoredProcedure

        sqlCmdObj.Parameters.AddWithValue("@IDSESCOMIT", Session("SESION_COMITE"))
        sqlConnection.Open()
