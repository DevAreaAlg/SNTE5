...
Public Class COB_DOC_GENERAR
    ...
    Private Sub LlenaEventos()
        ...
        Session("parm") = Session("cmd").CreateParameter("IDSUCURSAL", Session("adVarChar"), Session("adParamInput"), 10, Session("SUCID").ToString)
    ...
    Private Sub GeneraEventos()
        ...
        For i As Integer = 0 To dag_AsigEventos.Rows.Count() - 1
            ...
            If bandera = 1 Then
                ...
                ' lbl_status.Text = lbl_status.Text + " NOMDOC: " + dag_AsigEventos.Rows(i).Cells(9).Text '+ " IDPERSONA: " + dag_AsigEventos.Rows(i).Cells(7).Text + " NOMPERSONA: " + dag_AsigEventos.Rows(i).Cells(5).Text + " PAGATRA: " + dag_AsigEventos.Rows(i).Cells(10).Text
                GenerarFormato(dag_AsigEventos.Rows(i).Cells(9).Text, IDPERSONA, dag_AsigEventos.Rows(i).Cells(5).Text, dag_AsigEventos.Rows(i).Cells(10).Text, NUMFOLIO, IDPLANTILLA)
    ...
    Private Sub GenerarFormato(ByVal cNomArchivo As String, ByVal cIDCliente As String, ByVal cCliente As String, ByVal PagATRA As String, ByVal FOLIO As String, ByVal IDPLANTILLA As Integer)
    ...
    Private Sub ObtieneInfoPL2(ByVal NewDocName1 As String, ByVal cPath1 As String, ByVal cPathNewDoc1 As String, ByVal idCliente1 As String, ByVal nomCliente1 As String, ByVal pagAtra1 As String)
