<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterMascore.master" CodeBehind="COB_DESP_RESUMEN_DESP.aspx.vb" Inherits="SNTE5.COB_DESP_RESUMEN_DESP" MaintainScrollPositionOnPostback ="true" %>
                ...
                <div id="Resumen_Indicador">
                     <table border="1" style = "width:100%; text-align:left;">
                        <tr class="table_header">
                            <td colspan="6">Datos del despacho</td>
                            </tr>
                          <tr class="table_header">
                        ...
                        <tr>
                            <td colspan="6">
                                <label id="Label5" runat="server" class="texto">Clave despacho:</label> &nbsp;
                                <asp:Label ID="lbl_id_abogado" runat="server" class="texto"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="6">
                                <label id="Label2" runat="server" class="texto">Despacho:</label> &nbsp;
                         ...
                         <tr>
                           ...
                           <tr>
                            <td colspan="6">
                                <label id="Label6" runat="server" class="texto">Titular:</label> &nbsp;
                                <asp:Label ID="lbl_tit_res" runat="server" class="texto"></asp:Label>
                            </td>
                        </tr>
                           <tr>
                            <td colspan="6">
