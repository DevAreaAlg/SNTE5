<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterMascore.master" CodeBehind="COB_DESP_PERSONAF.aspx.vb" Inherits="SNTE5.COB_DESP_PERSONAF" MaintainScrollPositionOnPostback ="true" %>
        ...
        <ContentTemplate>
          <div class="semaforo_barra">
              ...
              <%--  <asp:LinkButton runat="server" OnClick="lnk_semafor_Click" Text="Domicilio" ID="lnk_to_adicionales">
                ...
                <asp:LinkButton runat="server" OnClick="lnk_semafor_Click" Text="Asignación de Usuarios" ID="lnk_to_users">
                    ...
                    <div class="panel-body_content" runat="server" id="content_panel_generales">
                     ...
                     <!--NOMBRES-->
                        ...
                        <div class="module_subsec flex_end">
                            <asp:Button ID="btn_guardar_g" class="btn btn-primary" runat="server"  ValidationGroup="val_Persona" Text="Guardar" AutoPostBack="False" />
                        </div>
                            </ContentTemplate>
                            <Triggers>
                                <asp:AsyncPostBackTrigger ControlID="btn_guardar_g" />
                            </Triggers>
                        </asp:UpdatePanel>
                    </div>
                </div>
