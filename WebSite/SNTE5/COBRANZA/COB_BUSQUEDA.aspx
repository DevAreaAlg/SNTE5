<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterMascore.master" CodeBehind="COB_BUSQUEDA.aspx.vb" Inherits="SNTE5.COB_BUSQUEDA" MaintainScrollPositionOnPostback ="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="panel-body">
            ...
            <div class="module_subsec columned low_m no_rm five_columns">
                <div class="module_subsec_elements text_input_nice_div flex_1">
                   <asp:TextBox ID="txt_id" class="module_subsec_elements module_subsec_small-elements text_input_nice_input" runat="server" MaxLength="9"></asp:TextBox>
                     <span class="text_input_nice_label">Clave de Abogado:</span>
    ...
    <div class="panel" style="background-color: transparent;">
        <div class="flex_end">
            <asp:Button ID="btn_nuevo" runat="server" class="btn btn-primary" Text="Nuevo Abogado" />
        </div>
    </div>
    ...
    <section class="panel">
        <div class="overflow_x shadow">
            ...
            <asp:DataGrid ID="dag_pendientes" runat="server" AutoGenerateColumns="False" CssClass="table table-striped"
                ...
                <Columns>
                    <asp:BoundColumn ItemStyle-Width="15%" DataField="IDDESPACHO" HeaderText="Clave abogado"></asp:BoundColumn>
